import numpy as np
pderesultslinearlinf = np.loadtxt("Porousaltresults.txt", comments="#", delimiter=",", unpack=False)
...
plt.savefig('Porousvstalt.pdf',bbox_inches="tight")
plt.show()
...
plt.ylabel('$\displaystyle \log(E_{\infty})$')
plt.savefig('Porousvsxalt.pdf',bbox_inches="tight")
plt.show()
...
plt.savefig('Porousvszscoretalt.pdf',bbox_inches="tight")
plt.show()
...
plt.xlabel('$\displaystyle \log(m/L)$')
plt.ylabel('$\displaystyle Z$')
plt.savefig('Porousvszscorexalt.pdf',bbox_inches="tight")
plt.show()
