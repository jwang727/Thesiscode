import numpy as np
pderesultslinearlinf = np.loadtxt("Porousintegralresults.txt", comments="#", delimiter=",", unpack=False)
...
plt.savefig('Porousintegralvst.pdf',bbox_inches="tight")
plt.show()
...
plt.ylabel('$\displaystyle \log(E_{\infty})$')
plt.savefig('Porousintegralvsx.pdf',bbox_inches="tight")
plt.show()
...
plt.savefig('Porousintegralvszscoret.pdf',bbox_inches="tight")
plt.show()
...
plt.xlabel('$\displaystyle \log(m/L)$')
plt.ylabel('$\displaystyle Z$')
plt.savefig('Porousintegralvszscorex.pdf',bbox_inches="tight")
plt.show()
